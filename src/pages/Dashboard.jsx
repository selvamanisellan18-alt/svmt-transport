...
export default function Dashboard({ onLogout }) {
  const [activeTab, setActiveTab] = useState('quotation-export');
  const [isQuotationMenuOpen, setIsQuotationMenuOpen] = useState(true);
              ...
              {isQuotationMenuOpen && (
                <div style={{ paddingLeft: '2.5rem', display: 'flex', flexDirection: 'column', width: '100%', marginTop: '0.25rem' }}>
                  <button 
                    ...
                    onClick={() => setActiveTab('quotation-export')}
                  ...
                  <button 
                    ...
                    onClick={() => setActiveTab('quotation-domestic')}
      ...
      <main className="dashboard-content">
        ...
        {activeTab.startsWith('quotation') && (
          <div style={{ padding: '20px', display: 'flex', justifyContent: 'center' }}>
            <Quotation type={activeTab === 'quotation-export' ? 'export' : 'domestic'} />
          </div>
        )}
